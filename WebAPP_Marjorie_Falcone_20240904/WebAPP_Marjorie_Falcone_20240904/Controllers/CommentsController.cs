...
namespace WebAPP_Marjorie_Falcone_20240904.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public CommentsController(WebAPP_Marjorie_Falcone_20240904Context context)
        {
            _context = context;
        }
        ...
        {
            var webAPP_Marjorie_Falcone_20240904Context = _context.Comment.Include(c => c.Post).Include(c => c.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAPP_Marjorie_Falcone_20240904Context.Comment'  is null.");
            }
            var comment = await _context.Comment.FindAsync(id);
            if (comment != null)
            {

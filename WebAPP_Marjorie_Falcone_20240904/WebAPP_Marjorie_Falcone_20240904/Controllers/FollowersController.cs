...
namespace WebAPP_Marjorie_Falcone_20240904.Controllers
{
    public class FollowersController : Controller
    {
        ...
        public FollowersController(WebAPP_Marjorie_Falcone_20240904Context context)
        {
            _context = context;
        }
        ...
        {
            var webAPP_Marjorie_Falcone_20240904Context = _context.Follower.Include(f => f.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAPP_Marjorie_Falcone_20240904Context.Follower'  is null.");
            }
            var follower = await _context.Follower.FindAsync(id);
            if (follower != null)
            {

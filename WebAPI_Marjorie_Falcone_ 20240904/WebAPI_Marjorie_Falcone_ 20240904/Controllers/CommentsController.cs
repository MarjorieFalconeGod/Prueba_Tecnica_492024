...
namespace WebAPI_Marjorie_Falcone__20240904.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public CommentsController(WebAPI_Marjorie_Falcone__20240904Context context)
        {
            _context = context;
        }
        ...
        {
            var webAPI_Marjorie_Falcone__20240904Context = _context.Comment.Include(c => c.Post).Include(c => c.User);
        ...
        public async Task<IActionResult> Create([Bind("CommentId,Text,DatePosted,UserId,PostId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommentId,Text,DatePosted,UserId,PostId")] Comment comment)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAPI_Marjorie_Falcone__20240904Context.Comment'  is null.");
            }
            var comment = await _context.Comment.FindAsync(id);
            if (comment != null)
            {

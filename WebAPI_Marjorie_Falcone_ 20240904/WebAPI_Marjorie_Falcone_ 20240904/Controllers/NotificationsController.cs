...
namespace WebAPI_Marjorie_Falcone__20240904.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public NotificationsController(WebAPI_Marjorie_Falcone__20240904Context context)
        {
            _context = context;
        }
        ...
        {
            var webAPI_Marjorie_Falcone__20240904Context = _context.Notification.Include(n => n.RelatedComment).Include(n => n.RelatedPost).Include(n => n.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAPI_Marjorie_Falcone__20240904Context.Notification'  is null.");
            }
            var notification = await _context.Notification.FindAsync(id);
            if (notification != null)
            {
